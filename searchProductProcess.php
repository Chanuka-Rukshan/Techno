...
$q = "SELECT * FROM `product_img` INNER JOIN `product` ON `product_img`.`product_id` = `product`.`id` WHERE `product`.`title` LIKE '%$product%'";
    ...
    ?>
        ...
        <div class="col-lg-2 ms-4 col-12 card_any  offset-lg-0 offset-2 mt-3">
            <div class="row ">
                ...
                <div class="card shadow-lg bg-body-tertiary rounded-2  mt-2 " style="width: 18rem; height: 480px;">

                    <a href="singleProductView.php?s=<?php echo $d["id"] ?>"><img src="<?php echo $d["img_path"] ?>" class="card-img-top img-thumbnail mt-2" style="height: 180px;" /></a>
                    <div class="card-body ms-0 m-0 text-center">
                        ...
                        <p class="text-primary text-start mt-2 "><?php
                                                                    ...
                                                                    ?></p>
                        <h6 class="mt-4">LKR <?php echo $d["price"] ?>.00</h6>
                        <p class="mt-1 text-danger">Shipping : LKR <?php echo $d["shipping_fee"] ?>.00</p>
        ...
        <nav aria-label="Page navigation example">
            <ul class="pagination">
                ...
                for ($y = 1; $y <= $num_of_pages; $y++) {
                    if ($y == $pageno) {
                ?>
                        <li class="page-item active"><a class="page-link" onclick="searshProduct(<?php echo $y ?>);"><?php echo $y ?></a></li>
